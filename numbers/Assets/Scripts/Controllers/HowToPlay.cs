...
public class HowToPlay : MonoBehaviour {
    ...
    string[] scripts =
    {
        ...
        "After that you can have another chance by touching that button.But you have to watch an Advertisement video.If you skip ads you can look at cards 2 seconds. If you watch it all you will have 5 seconds",
